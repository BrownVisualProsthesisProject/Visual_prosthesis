...
def third_approach():
    ...
    while True:
        ...
        if speech == "locate":
            ...
            if speech in labels:
                localize(imagehub, system, angles, times, speech)
            else:
                localize(imagehub, system, angles, times, None, False)


def localize(imagehub, system, angles, times, cls=None, understand_flag=True):
    if not understand_flag:
        system.describe_position(None, None, understand_flag)
        return
